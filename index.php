...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">SALUD360</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="#about">perfil de doctor</a></li>
...
Proyectar nuestra acción a la comunidad, por medio de acciones dirigidas a la prevención y el desarrollo de la salud de la población”.</p>
    ...
    <section id="departments" class="departments">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Somos una clínica fundada en la Ciudad de Santa Ana, con el objetivo de brindar salud integral a nuestros pacientes,pues el medico esta graduado en distintas especialidades tales como cardiologia, neurologia y medicina general con el objetivo de brindar una buena atencion a nuestros pacientes</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-toggle="tab" href="#tab-1">Medicina general </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-2">Neurologia</a>
              </li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab-2">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Neurologia</h3>
                    <p class="font-italic">Neurología y Neurocirugía es una unidad especializada en la atención y tratamiento de enfermedades del sistema nervioso. </p>
                    <p>Contamos con un equipo especializado que le permite al doctor brindar la artencio necesario a los pacientes en caso de poseer un problema con su sistema nervisoso</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
        ...
        <div class="faq-list">
          <ul>
            ...
            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-2" class="collapsed">Cuales son sus horarios de atención? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-2" class="collapse" data-parent=".faq-list">
                <p>
                  Lunes a viernes de 8 am a 5 pm, Sabados 8 am a 12 pm 
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-3" class="collapsed">Cuales son los requisitos para realizar una consulta? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-3" class="collapse" data-parent=".faq-list">
                <p>
                  Traer si DUI(en caso de ser menor de edad debe venir con un responsable), crear su perfil en linea(en caso de poder crear el perfil podra ser creado por la secretaria)
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="300">
              <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-4" class="collapsed">¿Puedo pedir la cita para otra persona? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-4" class="collapse" data-parent=".faq-list">
                <p>
                Sí, es posible. Solo es necesario que conozcas la información personal del paciente que es requerida para pedir la cita. Por ejemplo, nombre, documento de identidad, fecha de nacimiento, número de celular, estado civil y género. Sin embargo, si es mayor de edad deberás crear una cuenta aparte para esa persona.
                </p>
              </div>
            </li>
    ...
    <section id="contact" class="contact">
      ...
      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5490.942618027522!2d-89.56651410762831!3d13.983613473780126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f62e897d3b1c535%3A0xf7f18ac37092654c!2sCentro%20Medico%20de%20Santa%20Ana!5e1!3m2!1ses-419!2ssv!4v1622922293306!5m2!1ses-419!2ssv" frameborder="0" allowfullscreen></iframe>
      </div>
